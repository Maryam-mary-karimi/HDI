...
public class D_GW{
	...
	public String[] BF_required_For_BFVerification(Vector<DataNode> blocks, int tmpBfSize, FileWriter fw){
	...
	public DataNode[] tree_required_For_TreeVerification(Vector<DataNode> blocks,FileWriter fw){
